...
var RunFrame = (props) => {
  ...
  const handleReportAutoroutingLog = async (name, data) => {
    ...
    await registryKy.post("autorouting/bug_reports/create", {
      ...
      const isUnauthorized = error2 instanceof HTTPError && error2.response?.status === 401;
      if (isUnauthorized) {
      ...
      const message = error2 instanceof Error ? error2.message : "Failed to report autorouting bug";
      alert(`Failed to report autorouting bug: ${message}`);
    });
  };
  if (props.isLoadingFiles) {
    return /* @__PURE__ */ jsx4(LoadingSkeleton, {});
  }
  return /* @__PURE__ */ jsx4(ErrorBoundary, { FallbackComponent: RunFrameErrorFallback, children: /* @__PURE__ */ jsx4(
    CircuitJsonPreview,
    {
      ...
      leftHeaderContent: /* @__PURE__ */ jsxs3(Fragment, { children: [
        props.showRunButton && /* @__PURE__ */ jsx4(TooltipProvider, { children: /* @__PURE__ */ jsxs3(Tooltip, { children: [
          /* @__PURE__ */ jsx4(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxs3("div", { className: "rf-relative rf-inline-flex", children: [
            /* @__PURE__ */ jsxs3(
              "button",
              {
                type: "button",
                ...
                children: [
                  "Run",
                  " ",
                  isRunning || !dependenciesLoaded ? /* @__PURE__ */ jsx4(Loader2, { className: "rf-w-3 rf-h-3 rf-animate-spin" }) : /* @__PURE__ */ jsx4(Play, { className: "rf-w-3 rf-h-3" })
                ]
              }
            ),
            isRunning && /* @__PURE__ */ jsx4("div", { className: "rf-flex rf-items-center rf-ml-1", children: /* @__PURE__ */ jsx4(
              Button,
              {
                onClick: (e) => {
                  e.stopPropagation();
          ...
          /* @__PURE__ */ jsx4(
            TooltipContent,
            {
              ...
              children: /* @__PURE__ */ jsxs3("div", { className: "rf-flex rf-items-center rf-gap-2 rf-px-2.5 rf-py-1.5 rf-bg-slate-900 rf-rounded-md rf-shadow-xl rf-border rf-border-slate-800/60", children: [
                /* @__PURE__ */ jsx4("kbd", { className: "rf-bg-slate-800 rf-px-1.5 rf-py-0.5 rf-rounded rf-text-[10px] rf-font-sans rf-font-medium rf-border rf-border-slate-700 rf-text-slate-200 rf-leading-none", children: "Ctrl" }),
                /* @__PURE__ */ jsx4("span", { className: "rf-text-slate-500 rf-text-[11px] rf-font-medium rf-leading-none", children: "+" }),
                /* @__PURE__ */ jsx4("kbd", { className: "rf-bg-slate-800 rf-px-1.5 rf-py-0.5 rf-rounded rf-text-[10px] rf-font-sans rf-font-medium rf-border rf-border-slate-700 rf-text-slate-200 rf-leading-none", children: "Enter" })
              ] })
            }
          )
        ] }) }),
        props.showFileMenu !== false && /* @__PURE__ */ jsx4(
          FileMenuLeftHeader,
          {
...
var Command = React2.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx5(
  CommandPrimitive,
  {
    ref,
    className: cn(
...
var CommandInput = React2.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsxs4(
  "div",
  {
    className: "rf-flex rf-items-center rf-border-b rf-px-3",
    "cmdk-input-wrapper": "",
    children: [
      /* @__PURE__ */ jsx5(Search, { className: "rf-mr-2 rf-h-4 rf-w-4 rf-shrink-0 rf-opacity-50" }),
      /* @__PURE__ */ jsx5(
...
var CommandList = React2.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx5(
...
var CommandEmpty = React2.forwardRef((props, ref) => /* @__PURE__ */ jsx5(
...
var CommandGroup = React2.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx5(
...
var CommandSeparator = React2.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx5(
...
var CommandItem = React2.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx5(
...
var PopoverContent = React3.forwardRef(({ className, align = "center", sideOffset = 4, ...props }, ref) => /* @__PURE__ */ jsx6(PopoverPrimitive.Portal, { children: /* @__PURE__ */ jsx6(
...
var defaultFileIcon = (fileName) => {
  if (fileName.endsWith(".tsx") || fileName.endsWith(".jsx")) {
    return /* @__PURE__ */ jsx7(Code, { className: "rf-h-4 rf-w-4 rf-text-blue-500" });
  }
  if (fileName.endsWith(".md") || fileName.endsWith(".txt")) {
    return /* @__PURE__ */ jsx7(FileText, { className: "rf-h-4 rf-w-4 rf-text-gray-600" });
  }
...
var EnhancedFileSelectorCombobox = ({
  ...
  const recentFiles = useMemo3(() => {
    ...
    const validViewedFiles = recentlyViewedFiles.filter(
      (file2) => filteredFiles.includes(file2)
    );
  ...
  return /* @__PURE__ */ jsx7("div", { className: "rf-flex rf-items-center rf-gap-1", children: /* @__PURE__ */ jsxs5(
    Popover,
    {
      open,
      ...
      children: [
        /* @__PURE__ */ jsx7(PopoverTrigger, { asChild: true, children: /* @__PURE__ */ jsxs5(
          Button,
          {
            variant: "outline",
            role: "combobox",
            ...
            children: [
              /* @__PURE__ */ jsx7("span", { className: "rf-truncate rf-text-left", children: file ? getDisplayName(file) : placeholder }),
              /* @__PURE__ */ jsx7(ChevronsUpDown, { className: "rf-opacity-50 rf-flex-shrink-0" })
            ]
          }
        ) }),
        /* @__PURE__ */ jsx7(
          PopoverContent,
          {
            ...
            children: /* @__PURE__ */ jsxs5(Command, { shouldFilter: false, children: [
              ...
              recentFiles.length > 0 && /* @__PURE__ */ jsxs5("div", { className: "rf-border-b rf-border-gray-200", children: [
                /* @__PURE__ */ jsxs5(
                  "button",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsx7("span", { className: "rf-font-medium", children: "Recent Files" }),
                      /* @__PURE__ */ jsx7(
                        ChevronDown,
                        {
                          className: cn(
                ...
                showRecents && /* @__PURE__ */ jsx7("div", { className: "rf-pb-1", children: recentFiles.map((item, index) => /* @__PURE__ */ jsxs5(
                  "div",
                  {
                    ...
                    children: [
                      item.type === "saved" ? /* @__PURE__ */ jsx7("span", { title: "Recently saved", children: /* @__PURE__ */ jsx7(Save, { className: "rf-mr-2 rf-h-4 rf-w-4 rf-text-green-500" }) }) : /* @__PURE__ */ jsx7("span", { title: "Recently viewed", children: /* @__PURE__ */ jsx7(Clock, { className: "rf-mr-2 rf-h-4 rf-w-4 rf-text-blue-500" }) }),
                      /* @__PURE__ */ jsx7("span", { className: "rf-text-sm", children: getDisplayName(item.path.split("/").pop() || "") }),
                      /* @__PURE__ */ jsx7("span", { className: "rf-text-xs rf-text-muted-foreground rf-ml-2 rf-truncate rf-max-w-[40%]", children: getDirectoryPath2(item.path) }),
                      /* @__PURE__ */ jsx7(
                        Check,
                        {
                          className: cn(
              ...
              /* @__PURE__ */ jsxs5("div", { className: "rf-px-3 rf-py-2 rf-bg-slate-50 rf-flex rf-items-center rf-justify-between rf-gap-2", children: [
                /* @__PURE__ */ jsx7("div", { className: "rf-flex rf-items-center rf-text-xs rf-text-slate-600 rf-min-w-0 rf-flex-1", children: /* @__PURE__ */ jsxs5("div", { className: "rf-flex rf-items-center rf-min-w-0", children: [
                  /* @__PURE__ */ jsx7(
                    "button",
                    {
                  ...
                  currentFolder?.split("/").filter(Boolean).map((segment, index, array) => {
                    ...
                    return /* @__PURE__ */ jsxs5(
                      "span",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsx7("span", { className: "rf-mx-1 rf-flex-shrink-0", children: "/" }),
                          index === array.length - 1 ? /* @__PURE__ */ jsx7(
                            "span",
                            {
                ...
                /* @__PURE__ */ jsx7("div", { className: "rf-flex rf-items-center rf-gap-2 rf-flex-shrink-0", children: currentFolder && /* @__PURE__ */ jsxs5(
                  "button",
                  {
                    onClick: navigateUp,
                    ...
                    children: [
                      /* @__PURE__ */ jsx7(ArrowUp, { className: "rf-h-3 rf-w-3" }),
                      /* @__PURE__ */ jsx7("span", { className: "rf-text-xs rf-font-medium", children: "Up" })
                    ]
                  }
                ) })
              ] }),
              /* @__PURE__ */ jsx7(CommandList, { className: "rf-overflow-visible rf-max-h-none", children: !isSearching ? /* @__PURE__ */ jsxs5(Fragment2, { children: [
                /* @__PURE__ */ jsx7(CommandEmpty, { children: emptyMessage }),
                currentFiles.length > 0 && /* @__PURE__ */ jsx7(CommandGroup, { children: currentFiles.map((fileNode, index) => /* @__PURE__ */ jsxs5(
                  CommandItem,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsx7("span", { className: "rf-mr-2", children: defaultFileIcon(fileNode.name) }),
                      getDisplayName(fileNode.name),
                      /* @__PURE__ */ jsx7("div", { className: "rf-ml-auto rf-flex rf-items-center rf-gap-1", children: /* @__PURE__ */ jsx7(
                        Check,
                        {
                          className: cn(
                            "rf-h-4 rf-w-4",
                ...
                currentFolders.length > 0 && /* @__PURE__ */ jsx7(CommandGroup, { children: currentFolders.map((folderNode) => /* @__PURE__ */ jsxs5(
                  CommandItem,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsx7(Folder, { className: "rf-mr-2 rf-h-4 rf-w-4 rf-text-blue-600" }),
                      folderNode.name,
                      /* @__PURE__ */ jsx7(ChevronRight, { className: "rf-ml-auto rf-h-4 rf-w-4" })
                    ]
                  },
                  folderNode.path
                )) }),
                currentFiles.length === 0 && currentFolders.length === 0 && /* @__PURE__ */ jsx7("div", { className: "rf-p-4 rf-text-center rf-text-slate-500 rf-text-sm", children: "No files or folders in this directory" })
              ] }) : /* @__PURE__ */ jsx7(Fragment2, { children: searchResults.currentDirResults.length === 0 && searchResults.globalResults.length === 0 ? /* @__PURE__ */ jsxs5(CommandEmpty, { children: [
                'No files found matching "',
                searchValue,
                '".'
              ] }) : /* @__PURE__ */ jsxs5(Fragment2, { children: [
                searchResults.currentDirResults.length > 0 && /* @__PURE__ */ jsx7(CommandGroup, { children: searchResults.currentDirResults.map(
                  (file2, index) => /* @__PURE__ */ jsxs5(
                    CommandItem,
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsx7("span", { className: "rf-mr-2", children: defaultFileIcon(file2.fileName) }),
                        /* @__PURE__ */ jsxs5("div", { className: "rf-flex rf-items-center rf-w-full rf-min-w-0", children: [
                          /* @__PURE__ */ jsx7("span", { className: "rf-truncate rf-flex-1", children: getDisplayName(file2.fileName) }),
                          /* @__PURE__ */ jsx7("span", { className: "rf-text-xs rf-text-muted-foreground rf-ml-2 rf-truncate rf-max-w-[40%]", children: currentFolder || "/" }),
                          file2.path === currentFile && /* @__PURE__ */ jsx7(Check, { className: "rf-ml-2 rf-h-4 rf-w-4 rf-flex-shrink-0" })
                        ] })
                      ]
                    },
                    file2.path
                ...
                searchResults.globalResults.length > 0 && /* @__PURE__ */ jsx7(CommandGroup, { children: searchResults.globalResults.map((file2) => /* @__PURE__ */ jsxs5(
                  CommandItem,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxs5("div", { className: "rf-flex rf-items-center rf-w-full rf-min-w-0", children: [
                        /* @__PURE__ */ jsx7("span", { className: "rf-truncate rf-flex-1", children: getDisplayName(file2.fileName) }),
                        /* @__PURE__ */ jsx7("span", { className: "rf-text-xs rf-text-muted-foreground rf-ml-2 rf-truncate rf-max-w-[40%]", children: getDirectoryPath2(file2.path) }),
                        file2.path === currentFile && /* @__PURE__ */ jsx7(Check, { className: "rf-ml-2 rf-h-4 rf-w-4 rf-flex-shrink-0" })
                      ] })
                    ]
                  },
...
var RunFrameWithApi = (props) => {
  ...
  useEffect7(() => {
    ...
    const filesToConsider = visibleBoardFiles.length > 0 ? visibleBoardFiles : boardFiles;
  ...
  const handleRunCompleted = useCallback4(
    async (payload) => {
      try {
        ...
        debug4("Failed to push RUN_COMPLETED event", err);
      }
    },
    [pushEvent]
  );
  return /* @__PURE__ */ jsx8(
    RunFrame,
    {
      ...
      leftHeaderContent: /* @__PURE__ */ jsxs6("div", { className: "rf-flex rf-items-center rf-justify-between rf-w-full", children: [
        props.leftHeaderContent,
        props.showFilesSwitch && /* @__PURE__ */ jsx8("div", { className: "rf-absolute rf-left-1/2 rf-transform rf--translate-x-1/2", children: /* @__PURE__ */ jsx8(
...
var LoginDialog = ({
  ...
  const [loginState, setLoginState] = useState7("idle");
  const [loginUrl, setLoginUrl] = useState7(null);
  ...
  const handleSignIn = useCallback5(async () => {
    ...
    try {
      ...
      while (!abortControllerRef.current?.signal.aborted) {
        const { login_page: updatedLoginPage } = await ky2.post("sessions/login_page/get", {
          json: {
      ...
      const { session } = await ky2.post("sessions/login_page/exchange_for_cli_session", {
        json: {
          login_page_id: login_page.login_page_id
        },
        headers: {
  ...
  const isLoading = loginState === "creating" || loginState === "waiting" || loginState === "exchanging";
    ...
    Dialog,
    {
      ...
      children: /* @__PURE__ */ jsxs7(DialogContent, { className: "rf-max-w-md", children: [
        /* @__PURE__ */ jsxs7(DialogHeader, { children: [
          /* @__PURE__ */ jsx9(DialogTitle, { children: "Sign In Required" }),
          /* @__PURE__ */ jsx9(DialogDescription, { children: loginState === "idle" || loginState === "error" ? "Sign in to continue. A new browser window will open for authentication." : "Complete the login process in the opened browser window." })
        ] }),
        /* @__PURE__ */ jsxs7("div", { className: "rf-flex rf-flex-col rf-items-center rf-gap-4 rf-py-4", children: [
          loginState === "idle" || loginState === "error" ? /* @__PURE__ */ jsx9(Button, { onClick: handleSignIn, className: "rf-w-full", children: "Sign In" }) : /* @__PURE__ */ jsxs7("div", { className: "rf-flex rf-flex-col rf-items-center rf-gap-3 rf-w-full", children: [
            loginState !== "success" && /* @__PURE__ */ jsx9("div", { className: "rf-animate-spin rf-w-6 rf-h-6 rf-border-2 rf-border-gray-300 rf-border-t-blue-600 rf-rounded-full" }),
            /* @__PURE__ */ jsx9("p", { className: "rf-text-sm rf-text-gray-600 rf-text-center", children: getStatusMessage() }),
            loginUrl && loginState === "waiting" && /* @__PURE__ */ jsx9(
              "a",
              {
                href: loginUrl,
                target: "_blank",
                ...
                children: "Click here if the window didn't open"
              }
            )
          ] }),
          errorMessage && loginState === "error" && /* @__PURE__ */ jsx9("p", { className: "rf-text-sm rf-text-red-600 rf-text-center", children: errorMessage }),
...
var RunFrameForCli = (props) => {
  ...
  const [initialMainComponentPath] = useState8(() => {
...
var importComponentFromJlcpcb = async (jlcpcbPartNumber, opts) => {
  const { fetchEasyEDAComponent, convertRawEasyToTsx } = await loadEasyedaBrowser();
...
var ImportComponentDialog = ({
  ...
  const [selectedComponent, setSelectedComponent] = useState9(null);
  const [activeTab, setActiveTab] = useState9("tscircuit.com");
  const [detailsOpen, setDetailsOpen] = useState9(false);
  const [detailsComponent, setDetailsComponent] = useState9(null);
  const [packageDetails, setPackageDetails] = useState9(null);
  const [packageDetailsLoading, setPackageDetailsLoading] = useState9(false);
  const [previewActiveTab, setPreviewActiveTab] = useState9(
    "pcb"
  );
  const pushEvent = useRunFrameStore((s) => s.pushEvent);
  ...
  return /* @__PURE__ */ jsxs9(Dialog, { open: isOpen, onOpenChange: () => onClose(), children: [
      ...
      DialogContent,
      {
        ...
        children: [
          /* @__PURE__ */ jsxs9(DialogHeader, { children: [
            /* @__PURE__ */ jsx11(DialogTitle, { className: "rf-text-lg sm:rf-text-xl", children: "Import Component" }),
            /* @__PURE__ */ jsx11(DialogDescription, { className: "rf-text-sm", children: "Search for components from tscircuit.com or JLCPCB parts library." })
          ] }),
          /* @__PURE__ */ jsxs9(
            Tabs,
            {
              ...
              children: [
                /* @__PURE__ */ jsxs9(TabsList, { className: "rf-grid rf-w-full rf-grid-cols-1 sm:rf-grid-cols-3 rf-h-auto", children: [
                  ...
                  /* @__PURE__ */ jsx11(TabsTrigger, { value: "jlcpcb", className: "rf-text-xs sm:rf-text-sm", children: "JLCPCB Parts" }),
                  /* @__PURE__ */ jsx11(TabsTrigger, { value: "kicad", className: "rf-text-xs sm:rf-text-sm", children: "KiCad" })
                ] }),
                /* @__PURE__ */ jsxs9("div", { className: "rf-flex rf-items-center rf-gap-2 rf-mt-4", children: [
                  /* @__PURE__ */ jsxs9("div", { className: "rf-relative rf-flex-grow", children: [
                    /* @__PURE__ */ jsx11(Search2, { className: "rf-absolute rf-left-2 rf-top-2.5 rf-h-4 rf-w-4 rf-text-muted-foreground" }),
                    /* @__PURE__ */ jsx11(
                      Input,
                      {
                  ...
                  /* @__PURE__ */ jsx11(
                    Button,
                    {
                      ...
                      children: isLoading ? /* @__PURE__ */ jsx11(Loader22, { className: "rf-h-4 rf-w-4 rf-animate-spin" }) : /* @__PURE__ */ jsxs9(Fragment4, { children: [
                        /* @__PURE__ */ jsx11(Search2, { className: "rf-h-4 rf-w-4 sm:rf-hidden" }),
                        /* @__PURE__ */ jsx11("span", { className: "rf-hidden sm:rf-inline", children: "Search" })
                      ] })
                    }
                  )
                ] }),
                /* @__PURE__ */ jsx11("div", { className: "rf-mt-4 rf-flex-1 rf-min-h-[200px] !rf-max-h-[40vh] !rf-overflow-y-auto rf-border rf-rounded-md", children: searchResults.length > 0 ? /* @__PURE__ */ jsx11("div", { className: "rf-divide-y", children: searchResults.map((result) => /* @__PURE__ */ jsxs9(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxs9("div", { className: "rf-min-w-0 rf-overflow-hidden", children: [
                        /* @__PURE__ */ jsx11("div", { className: "rf-font-medium rf-text-sm rf-truncate", children: result.name }),
                  ...
                  /* @__PURE__ */ jsx11(Loader22, { className: "rf-h-8 rf-w-8 rf-animate-spin rf-mx-auto rf-mb-2" }),
                  /* @__PURE__ */ jsx11("p", { children: "Searching..." })
                ] }) : /* @__PURE__ */ jsx11("div", { className: "rf-p-8 rf-text-center rf-text-zinc-500", children: hasSearched ? "No results found" : "Enter a search term to find components" }) })
              ]
            }
          ),
    ...
    /* @__PURE__ */ jsx11(Dialog, { open: detailsOpen, onOpenChange: setDetailsOpen, children: /* @__PURE__ */ jsxs9(
      DialogContent,
      {
        showOverlay: false,
        style: {
        ...
        children: [
          /* @__PURE__ */ jsx11(DialogHeader, { className: "rf-pb-4 rf-border-b", children: /* @__PURE__ */ jsx11("div", { className: "rf-flex rf-items-start rf-justify-between rf-gap-4", children: /* @__PURE__ */ jsx11("div", { className: "rf-flex-1 rf-min-w-0", children: /* @__PURE__ */ jsx11(DialogTitle, { className: "rf-text-xl rf-font-semibold rf-truncate", children: detailsComponent?.source === "kicad" ? detailsComponent?.name : /* @__PURE__ */ jsx11(
            "a",
            {
          ...
          /* @__PURE__ */ jsx11("div", { className: "rf-flex-1 rf-overflow-y-auto rf-py-4 rf-space-y-6", children: detailsComponent?.source === "tscircuit.com" ? /* @__PURE__ */ jsxs9(Fragment4, { children: [
            /* @__PURE__ */ jsx11("div", { children: /* @__PURE__ */ jsx11("div", { className: "rf-space-y-3", children: detailsComponent?.owner && /* @__PURE__ */ jsxs9("div", { children: [
              /* @__PURE__ */ jsx11("label", { className: "rf-text-xs rf-font-medium rf-text-gray-500 rf-uppercase rf-tracking-wide", children: "Created by" }),
              /* @__PURE__ */ jsx11("div", { className: "rf-mt-1 rf-text-sm rf-font-medium", children: /* @__PURE__ */ jsx11(
                "a",
                {
            ...
            /* @__PURE__ */ jsxs9("div", { children: [
              /* @__PURE__ */ jsx11("h3", { className: "rf-text-lg rf-font-semibold rf-mb-4", children: "Preview" }),
              /* @__PURE__ */ jsxs9(
                Tabs,
                {
                    ...
                    /* @__PURE__ */ jsxs9("div", { className: "rf-mt-4", children: [
                      /* @__PURE__ */ jsx11(
                        TabsContent,
                        {
                          ...
                          children: detailsComponent?.owner && detailsComponent?.name ? /* @__PURE__ */ jsx11("div", { className: "rf-w-full rf-h-fit rf-min-h-[300px] rf-bg-white rf-flex rf-items-center rf-justify-center rf-p-4", children: /* @__PURE__ */ jsx11(
                            "img",
                            {
                          ...
                          ) }) : /* @__PURE__ */ jsx11("div", { className: "rf-h-[400px] rf-flex rf-items-center rf-justify-center rf-text-gray-500", children: /* @__PURE__ */ jsxs9("div", { className: "rf-text-center", children: [
                            /* @__PURE__ */ jsx11("div", { className: "rf-text-sm rf-font-medium", children: "No PCB preview available" }),
                            /* @__PURE__ */ jsx11("div", { className: "rf-text-xs rf-mt-1", children: "Preview cannot be generated" })
                          ] }) })
                        }
                      ),
                      /* @__PURE__ */ jsx11(
                        TabsContent,
                        {
                          ...
                          children: detailsComponent?.owner && detailsComponent?.name ? /* @__PURE__ */ jsx11("div", { className: "rf-w-full rf-h-fit rf-min-h-[300px] rf-bg-white rf-flex rf-items-center rf-justify-center rf-p-4", children: /* @__PURE__ */ jsx11(
                            ...
                            /* @__PURE__ */ jsx11("div", { className: "rf-text-sm rf-font-medium", children: "No schematic preview available" }),
                            /* @__PURE__ */ jsx11("div", { className: "rf-text-xs rf-mt-1", children: "Preview cannot be generated" })
                          ] }) })
                        }
                      )
            ...
            packageDetails?.ai_description && /* @__PURE__ */ jsxs9("div", { children: [
              /* @__PURE__ */ jsx11("h3", { className: "rf-text-lg rf-font-semibold rf-mb-3", children: "AI Description" }),
              /* @__PURE__ */ jsx11("div", { className: "rf-bg-gray-50 rf-border rf-border-gray-200 rf-rounded-lg rf-p-4", children: /* @__PURE__ */ jsx11("p", { className: "rf-text-sm rf-text-gray-700 rf-leading-relaxed", children: packageDetails.ai_description }) })
            ] }),
            packageDetails?.ai_usage_instructions && /* @__PURE__ */ jsxs9("div", { children: [
              /* @__PURE__ */ jsx11("h3", { className: "rf-text-lg rf-font-semibold rf-mb-3", children: "Usage Instructions" }),
              /* @__PURE__ */ jsx11("div", { className: "rf-bg-gray-50 rf-border rf-border-gray-200 rf-rounded-lg rf-p-4", children: /* @__PURE__ */ jsx11("p", { className: "rf-text-sm rf-text-gray-700 rf-leading-relaxed rf-whitespace-pre-wrap", children: packageDetails.ai_usage_instructions }) })
            ] }),
            packageDetailsLoading && /* @__PURE__ */ jsxs9("div", { className: "rf-flex rf-justify-center rf-text-center rf-items-center rf-gap-2 rf-text-gray-500", children: [
              /* @__PURE__ */ jsx11(Loader22, { className: "rf-h-4 rf-w-4 rf-animate-spin" }),
              /* @__PURE__ */ jsx11("span", { className: "rf-text-sm", children: "Loading package details..." })
            ] })
          ] }) : null }),
          /* @__PURE__ */ jsxs9(DialogFooter, { className: "rf-pt-4 rf-border-t rf-flex rf-flex-col sm:rf-flex-row rf-justify-between rf-items-stretch sm:rf-items-center rf-gap-2", children: [
            /* @__PURE__ */ jsx11("div", { className: "rf-flex-1 rf-order-3 sm:rf-order-1", children: detailsComponent?.source === "tscircuit.com" && /* @__PURE__ */ jsxs9(
              Button,
              {
                variant: "outline",
                size: "sm",
                ...
                children: [
                  /* @__PURE__ */ jsx11(ExternalLink, { className: "rf-h-4 rf-w-4" }),
...
var RunFrameStaticBuildViewer = (props) => {
  ...
  const [isLoadingCurrentFile, setIsLoadingCurrentFile] = useState10(false);
  const [fileCache, setFileCache] = useState10({});
  const [loadingFiles, setLoadingFiles] = useState10(/* @__PURE__ */ new Set());
  ...
  if (availableFiles.length === 0) {
    return /* @__PURE__ */ jsx13("div", { className: "rf-flex rf-flex-col rf-w-full rf-h-full rf-items-center rf-justify-center", children: /* @__PURE__ */ jsxs10("div", { className: "rf-text-center rf-p-8", children: [
      /* @__PURE__ */ jsx13("h3", { className: "rf-text-lg rf-font-semibold rf-text-gray-800 rf-mb-2", children: "No Circuit JSON Files Found" }),
      /* @__PURE__ */ jsx13("p", { className: "rf-text-sm rf-text-gray-600", children: "Please provide circuit JSON files to view." })
    ] }) });
  }
  ...
  return /* @__PURE__ */ jsx13(
    ErrorBoundary2,
    {
      fallbackRender: ({ error }) => /* @__PURE__ */ jsx13("div", { className: "rf-mt-4 rf-mx-4 rf-bg-red-50 rf-rounded-md rf-border rf-border-red-200", children: /* @__PURE__ */ jsxs10("div", { className: "rf-p-4", children: [
        /* @__PURE__ */ jsx13("h3", { className: "rf-text-lg rf-font-semibold rf-text-red-800 rf-mb-3", children: "Error loading Circuit JSON Preview" }),
        /* @__PURE__ */ jsx13("p", { className: "rf-text-xs rf-font-mono rf-whitespace-pre-wrap rf-text-red-600 rf-mt-2", children: error.message })
      ] }) }),
      children: currentFileFailed ? /* @__PURE__ */ jsxs10("div", { className: "rf-w-full rf-h-full rf-flex rf-flex-col", children: [
        /* @__PURE__ */ jsxs10("div", { className: "rf-flex rf-items-center rf-justify-between rf-w-full rf-p-4 rf-border-b rf-border-gray-200", children: [
          (props.showFileMenu ?? true) && /* @__PURE__ */ jsx13(
            FileMenuLeftHeader,
            {
              isWebEmbedded: true,
              circuitJson: null,
          ...
          availableFiles.length > 1 && /* @__PURE__ */ jsx13("div", { className: "rf-absolute rf-left-1/2 rf-transform rf--translate-x-1/2 rf-flex rf-items-center rf-gap-2", children: /* @__PURE__ */ jsx13(
        ...
        /* @__PURE__ */ jsx13("div", { className: "rf-flex-1 rf-flex rf-items-center rf-justify-center", children: /* @__PURE__ */ jsxs10("div", { className: "rf-text-center rf-p-8", children: [
          /* @__PURE__ */ jsx13("h3", { className: "rf-text-lg rf-font-semibold rf-text-red-600 rf-mb-2", children: "Failed to Load Circuit File" }),
          ...
          /* @__PURE__ */ jsxs10("div", { className: "rf-flex rf-flex-col rf-items-center rf-gap-2", children: [
            ...
            availableFiles.length > 1 && /* @__PURE__ */ jsx13("p", { className: "rf-text-xs rf-text-gray-500", children: "Or select a different file from the dropdown above" })
          ] })
        ] }) })
      ] }) : /* @__PURE__ */ jsx13(
        CircuitJsonPreview,
        {
          ...
          leftHeaderContent: /* @__PURE__ */ jsxs10("div", { className: "rf-flex rf-items-center rf-justify-between rf-w-full", children: [
            ...
            availableFiles.length > 1 && /* @__PURE__ */ jsx13(
              "div",
              {
