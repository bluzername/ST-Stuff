...
// lib/plumbing/getElementsOutsideTree.ts
var getElementOutsideTree = (db, tree) => {
  const componentIdsInTree = /* @__PURE__ */ new Set();
...
var convertCircuitJsonToPackOutput = (circuitJson, opts = {}) => {
  ...
  const sourcePortToPadIds = /* @__PURE__ */ new Map();
  ...
  const sourceTraces = typeof db.source_trace.list === "function" ? db.source_trace.list() : circuitJson.filter((item) => item.type === "source_trace");
  for (const sourceTrace of sourceTraces) {
    ...
    const shouldCreateWeightedConnections = connectedPorts.length === 2 && connectedNets.length === 0;
