...
// lib/A0201.tsx
import { Cuboid as Cuboid2 } from "jscad-fiber";
...
// lib/A0402.tsx
import { Cuboid as Cuboid3 } from "jscad-fiber";
...
// lib/A0603.tsx
import { Cuboid as Cuboid4 } from "jscad-fiber";
...
// lib/A0805.tsx
import { Cuboid as Cuboid5 } from "jscad-fiber";
...
// lib/A1206.tsx
import { Cuboid as Cuboid6 } from "jscad-fiber";
...
// lib/A1210.tsx
import { Cuboid as Cuboid7 } from "jscad-fiber";
...
// lib/A2010.tsx
import { Cuboid as Cuboid8 } from "jscad-fiber";
...
// lib/A2512.tsx
import { Cuboid as Cuboid9 } from "jscad-fiber";
...
var BGA = ({
  ...
  return /* @__PURE__ */ jsxs10(Fragment10, { children: [
    ...
    !footprintString && Array.from({ length: ballRows * ballColumns }).map((_, index) => {
      ...
      return /* @__PURE__ */ jsx10(Translate2, { x, y, z: ballOffset, children: /* @__PURE__ */ jsx10(Sphere, { radius: ballDiameter / 2 }) }, index);
    }),
      ...
      if (elm.type === "pcb_smtpad") {
        return /* @__PURE__ */ jsx10(
          Translate2,
          {
            ...
            y: elm.y,
            z: ballOffset,
            children: /* @__PURE__ */ jsx10(Sphere, { radius: ballDiameter / 2 })
          },
          index
        );
      }
...
var DipPinLeg = ({ x, y, z }) => {
  ...
  return /* @__PURE__ */ jsxs14(Fragment12, { children: [
    /* @__PURE__ */ jsx15(Translate6, { offset: { x: x + 0.25 / 2, y, z }, children: /* @__PURE__ */ jsx15(Rotate3, { rotation: ["-90deg", 0, "90deg"], children: /* @__PURE__ */ jsx15(ExtrudeLinear, { height: 0.25, children: /* @__PURE__ */ jsx15(
      Polygon,
      {
