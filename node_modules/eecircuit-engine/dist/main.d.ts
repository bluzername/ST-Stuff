...
export declare class Simulation {
    private wasmModuleInitCount;
    private completedRunCount;
    __getWasmInitCountForTests(): number;
    __getCompletedRunCountForTests(): number;
    __getCommandListForTests(): string[];
    private pass;
    private commandList;
    private isNoiseMode;
    private cmd;
